...
class GameServer:
    ...
    def process_object(self, obj):
        ...
        match type(obj):
            case raiders.Player:
                info = (-1, obj.pos[0], obj.pos[1], obj.health, obj.angle, obj.hit, *obj.color, obj.active, obj.attack_tick, obj.frames)
            case raiders.Heal:
            ...
            case raiders.Base:
                info = (13, obj.pos[0], obj.pos[1], 0, 0, 0, 0, 0, 0)
    ...
    def game_loop(self):
        ...
        try:
            while self.running:
                ...
                frame = self.env.env.surface.copy()
...
if __name__ == "__main__":
    ...
    myip = "127.0.0.1"
    agent_scripts = [
        ([], env_utils.agents.BasicAgent())
    ]
    server = GameServer(host=myip, port=9999, teams=[5,5], agent_scripts=agent_scripts)
